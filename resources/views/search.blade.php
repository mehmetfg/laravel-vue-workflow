                ...
                <div class="m-login__signin">
                    <div class="m-login__head">
                        <h3 class="m-login__title">
                            ...
                            <p><span class="badge-primary badge" >Cihaz Durum Sorgulama Ekranı</span></p>
                        </h3>
                    </div>
                    <form class="m-login__form m-form" action="/workorder/do_query" method="post">
                        @csrf
                        <div class="form-group m-form__group">
                            <input class="form-control m-input"  name="tag" type="text" placeholder="Künye" >
                        </div>
