                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title" >
                        <h3 class="m-portlet__head-text">
                            <i class="fa fa-gears  fa-2x" style="font-size: 30px;margin-right: 5px"></i>   Cihaz {{product.id ? 'Güncelle' :'Ekle'}}
                        </h3>
                    </div>
                </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input   class="form-control m-input--air m-input" placeholder="Künye" v-model="product.tag">
                        </div>
                        <div class="col-lg-4">
                            <label class="">
                               Açıklama
