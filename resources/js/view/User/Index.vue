                ...
                <div class="m-section">
                    ...
                    <div class="m-section__content">
                        <table class="table">
                            ...
                            <tr v-for="item in users" :class="" :key="item.id">
                                <td>
                                ...
                                <td data-field="Actions"
                                    ...
                                    <router-link
                                            :to="{ name:'edit-user', params : { user : item}}">
    ...
    export default {
        ...
        return array.indexOf(item)
            ...
            isActiveSetter(user) {
                ...
                user.status = document.querySelector('#mycheckbox' + user.id).checked;

                if(user.status){
                    this.statusText="Geldi"

                }
                this.$store.dispatch("userStatusSetter", user);
            },
